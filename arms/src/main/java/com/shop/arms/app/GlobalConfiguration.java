...
import com.shop.arms.BuildConfig;
import com.shop.arms.app.api.coverter.CustomGsonConverterFactory;
import com.shop.arms.app.base.BaseUrlInterceptor;
...
import static com.shop.mall.app.Api.BASE_URL;
import static com.shop.mall.app.Api.LOG_DEBUG;
...
public final class GlobalConfiguration implements ConfigModule {
    ...
    public void applyOptions(@NonNull Context context, @NonNull GlobalConfigModule.Builder builder) {
        if (!LOG_DEBUG) { //Release 时, 让框架不再打印 Http 请求和响应的信息
...
//                    @Override
//                    public HttpUrl url() {
//                        return HttpUrl.parse(ApiKt.getAPP_DOMAIN());
//                    }
//                })
...
//                    okhttpBuilder.sslSocketFactory(); //支持 Https, 详情请百度
                        ...
                        // 由于GlobalConfiguration初始化在Application onCreate之前 所以把flipper的初始化放这儿
//                    SoLoader.init(context, false);
//                    FlipperClient instance = AndroidFlipperClient.getInstance(context);
//                    FlipperInitializer.IntializationResult intializationResult = FlipperInitializer.INSTANCE.initFlipperPlugins(context, instance);
//                    if (BuildConfig.DEBUG && intializationResult.getFlipperNetWorkInterceptor() != null) {
//                        okhttpBuilder.addNetworkInterceptor(intializationResult.getFlipperNetWorkInterceptor());
//                    }
                    }
                })
