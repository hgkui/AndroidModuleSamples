package com.shop.arms.app.helper
import android.content.Context
import android.content.SharedPreferences
import com.google.gson.Gson
import com.shop.arms.app.MyApplication
...
//    }
    ...
    override fun putIsPreHot(boolean: Boolean) {
        mSharedPreferences.edit().putBoolean(
            KEY_SP_IS_PRE_HOT, boolean).apply()
    }

    /**
     * 获取是否预热
     */
    override fun getIsPreHot() = mSharedPreferences.getBoolean(
        KEY_SP_IS_PRE_HOT, false)
    ...
    override fun putShownPrivacyNotify(shown: Boolean) {
        mSharedPreferences.edit().putBoolean(
            KEY_SP_SHOWN_PRIVACY_NOTIFY, shown).apply()
    }
    ...
    override fun getShownPrivacyNotify(): Boolean =
        mSharedPreferences.getBoolean(
            KEY_SP_SHOWN_PRIVACY_NOTIFY, false)
